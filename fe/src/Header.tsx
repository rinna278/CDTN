...
const Header = ({ selected, setSelected }: HeaderProps) => {
  ...
  // Đồng bộ selected với URL khi reload/navigation
  useEffect(() => {
    const routeId =
  ...
  const handleSearch = () => {
    if (modalSearchRef.current) {
      modalSearchRef.current.style.display =
        modalSearchRef.current.style.display === "block" ? "none" : "block";
    }
  };
              ...
              <div className="search-and-cart">
                <div className="search">
                  ...
                  <div className="modal-search" ref={modalSearchRef}>
                    <input placeholder="Tìm kiếm hoa"></input>
                  </div>
                </div>
